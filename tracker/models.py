...
class Habit(models.Model):
    ...
    relation_habit = (
        models.ForeignKey(  # указываем приятную привычку для полезной привычки
            "tracker.Habit",
    ...
    is_pleasant = models.BooleanField(  #  True для приятной привычки
        default=False, blank=True, null=True, verbose_name="приятность привычки"
    )
    ...
    is_public = models.BooleanField(
        default=False, blank=True, verbose_name="доступность другим пользователям"
    )
